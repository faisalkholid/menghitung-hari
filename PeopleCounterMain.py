...
if __name__ == "__main__":
    ...
    while True:
        ...
        for c in cnts:
            ...
            # cv2.line(frame, (width // 2, 0), (width, 550000), (250, 0, 1), 2)  # blue line
            # cv2.line(frame, (width // 2 -100, 0), (width - 50, 550000), (0, 0, 255), 2)  # red line

            cv2.line(frame, (width // 2, 0), (width, 450), (250, 0, 1), 2)  # blue line
            cv2.line(frame, (width // 2 - 100, 0), (width - 50, 540), (0, 0, 255), 2)  # red line
